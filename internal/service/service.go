...
type Service struct {
	...
	corrByIDMu sync.RWMutex
	corrByID   map[string]*model.Correlation
}

// New 构造服务。
func New(st *store.Store) *Service {
	return &Service{store: st, standardizer: normalize.NewStandardizer(), corrByID: map[string]*model.Correlation{}}
}
